.onLoad <- function(lib, pkg)
{
    ...
    ###########################################################################
    ##
    ## NewYears actual day Jan 1st
    ##
    registerHolidays('NewYears', as.Date(ISOdate(1980:2020, 1, 1)))

    ###########################################################################
    ##
    ## NEWYEAR US financial holiday -- if Jan 1st is on a Sunday, then the Monday is a holiday,
    ## but if Jan 1st is on a Saturday, then there is no holiday.
    ##
    ...
    ##
    ## From NYSE rules: Holidays -- The Board has determined
    ## that the Exchange will not be open for business on
    ## New Year's Day, Martin Luther King, Jr. Day,
    ## Washington's Birthday, Good Friday, Memorial Day,
    ## Independence Day, Labor Day, Thanksgiving Day and
    ## Christmas Day. Martin Luther King, Jr. Day,
    ## Washington's Birthday and Memorial Day will be
    ## celebrated on the third Monday in January, the third
    ## Monday in February and the last Monday in May,
    ## respectively
    ##
    ## The Exchange Board has also determined that, when any
    ## holiday observed by the Exchange falls on a Saturday,
    ## the Exchange will not be open for business on the
    ## preceding Friday and when any holiday observed by the
    ## Exchange falls on a Sunday, the Exchange will not be
    ## open for business on the succeeding Monday, unless
    ## unusual business conditions exist, such as the ending
    ## of a monthly or the yearly accounting period.
    ##
    ## If Jan 1st is on a Saturday, then no New Year's day holiday.
    ##
    ...
    c(
         ...
         "2018/12/05"   # funeral of former President George HW Bush
    )))
